...
<div class="nav justify-content-center">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="crud" class="nav-link active">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">CRUD Operations</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <table class="table">
      <div class= "card-header">
        <h5>
          ...
          <a href = "<?php echo base_url('student/add')?>" class = "btn btn-outline-primary float-right">Add Student</a>
        </h5>
      </div>
  <thead>
    <tr>
  ...
  <tbody>
    <tr>
      ...
      <td>Mark</td>
      <td>Otto</td>
      <td> <a href = "<?php echo base_url('student/edit')?>" class = "btn btn-outline-primary ">Edit</a>
       <a href = "<?php echo base_url('student/edit')?>" class = "btn btn-outline-danger">Delete</a>
      </td>
    </tr>
    <tr>
      <th scope="row">2</th>
