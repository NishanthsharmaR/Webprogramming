...
<script>
 ...
 <script type="text/javascript">
	...
	<script src="<?php echo base_url(); ?>assets/plugins/bower_components/dropzone-master/dist/dropzone.js" ></script>
    ...
    <!--slimscroll JavaScript -->
	 <!-- icheck -->
    <script src="<?php echo base_url(); ?>assets/plugins/bower_components/icheck/icheck.min.js" ></script>
    <script src="<?php echo base_url(); ?>assets/plugins/bower_components/icheck/icheck.init.js" ></script>
 ...
 <!-- Calendar JavaScript -->
    ...
    <script src="<?php echo base_url(); ?>assets/plugins/bower_components/styleswitcher/jQuery.style.switcher.js" ></script>
	 <script src="<?php echo base_url(); ?>assets/plugins/bower_components/html5-editor/wysihtml5-0.3.0.js" ></script>
    <script src="<?php echo base_url(); ?>assets/plugins/bower_components/html5-editor/bootstrap-wysihtml5.js" ></script>
	...
	<link rel="stylesheet" href="<?php echo base_url(); ?>assets/plugins/bower_components/bootstrap-rtl-master/dist/js/bootstrap-rtl.min.js" >
    ...
    $(document).ready(function($) {
	 ...
	 <!-- Chart Files -->
		...
		<script src="<?php echo base_url(); ?>assets/flot.tooltip/flot.tooltip.js"></script>
		...
		<script src="<?php echo base_url(); ?>assets/liquid-meter/liquid.meter.js"></script>
		<script src="<?php echo base_url(); ?>assets/snap.svg/snap.svg.js"></script>
		<script src="<?php echo base_url(); ?>assets/snap.svg/snap.svg.js"></script>
		<script src="<?php echo base_url(); ?>assets/liquid-meter/liquid.meter.js"></script>
...
<script src="<?php echo base_url(); ?>assets/js/jquery.PrintArea.js" type="text/JavaScript"></script>
    ...
    $(document).ready(function() {
	  ...
	  <!-- Chart JS -->
	<!-- <script src="<?php echo base_url(); ?>assets/fullcalendar/js/index.js"></script>-->
...
<script>
	...
	<script type="text/javascript" src="<?php echo base_url(); ?>assets/date/daterangepicker.min.js"></script>
	<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/date/daterangepicker.css" />
	<script src="<?php echo base_url(); ?>assets/plugins/bower_components/Magnific-Popup-master/dist/jquery.magnific-popup.min.js"></script>
    <script src="<?php echo base_url(); ?>assets/plugins/bower_components/Magnific-Popup-master/dist/jquery.magnific-popup-init.js"></script>
...
<script type="text/javascript">
 ...
 <!-- jQuery file upload -->
    ...
    $('#blockbtn5').click(function() {
        $('div.block5').block({
            message: '<h4><img src="<?php echo base_url(); ?>assets/plugins/images/busy.gif" /> Just a moment...</h4>',
            css: {
                border: '1px solid #fff'
            }
        });
    ...
    <script src="<?php echo base_url(); ?>assets/idle/jquery.idletimeout.js"></script>
    <script src="<?php echo base_url(); ?>assets/idle/jquery.idletimer.js"></script>
    <script src="<?php echo base_url(); ?>assets/idle/session-timeout-idle-init.js"></script>
    -->
